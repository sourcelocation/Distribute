...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("text-lg leading-none font-bold uppercase tracking-widest text-primary", className)}
      {...props} />
  );
}
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn("text-muted-foreground text-[10px] uppercase font-mono tracking-wider opacity-60 mt-1", className)}
      {...props} />
  );
}
